	...
	class RWMB_File_Advanced_Field extends RWMB_File_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'rwmb-file-advanced', 'rwmbFileAdvanced', array(
				'frameTitle' => esc_html__( 'Select Files', 'starbella' ),
			) );
		}
		...
		{
			$i18n_title  = apply_filters( 'rwmb_file_advanced_select_string', _x( 'Select or Upload Files', 'file upload', 'starbella' ), $field );
		...
		static function print_templates()
		{
            ...
            <script id="tmpl-rwmb-file-advanced" type="text/html">
				...
				<li>
					...
					<div class="rwmb-info">
						<a href="{{{ attachment.url }}}" target="_Self">{{{ attachment.title }}}</a>
						<p>{{{ attachment.mime }}}</p>
						<a title="<?php echo $i18n_edit; ?>" href="{{{ attachment.editLink }}}" target="_Self"><?php echo $i18n_edit; ?></a> |
