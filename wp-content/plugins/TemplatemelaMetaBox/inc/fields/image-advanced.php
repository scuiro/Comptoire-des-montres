...

	{
...

		{
			...
			wp_localize_script( 'rwmb-image-advanced', 'rwmbImageAdvanced', array(
				...
				'frameTitle' => esc_html__( 'Select Images', 'starbella' ),
...

		{
			...
			$i18n_title = apply_filters( 'rwmb_image_advanced_select_string', _x( 'Select or Upload Images', 'image upload', 'starbella' ), $field );
...

		{
			...
			$i18n_delete = apply_filters( 'rwmb_image_delete_string', _x( 'Delete', 'image upload', 'starbella' ) );

			$i18n_edit   = apply_filters( 'rwmb_image_edit_string', _x( 'Edit', 'image upload', 'starbella' ) );
            ...
            <script id="tmpl-rwmb-image-advanced" type="text/html">
				...
				<li id="item_{{{ attachment.id }}}">
					...
					<div class="rwmb-image-bar">
						...
						<a title="<?php echo $i18n_edit; ?>" class="rwmb-edit-file" href="{{{ attachment.editLink }}}" target="_Self"><?php echo $i18n_edit; ?></a> |

						<a title="<?php echo $i18n_delete; ?>" class="rwmb-delete-file" href="#" data-attachment_id="{{{ attachment.id }}}">&#42</a>
