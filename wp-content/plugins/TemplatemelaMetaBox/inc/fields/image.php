...

{
...

	{
...

		{
			...
			$i18n_title = apply_filters( 'rwmb_image_upload_string', _x( 'Upload Images', 'image upload', 'starbella' ), $field );

			$i18n_more  = apply_filters( 'rwmb_image_add_string', _x( '+ Add new image', 'image upload', 'starbella' ), $field );
			...
			$li = '
				...
				<li id="item_%s">
					...
					<div class="rwmb-image-bar">
						...
						<a title="%s" class="rwmb-edit-file" href="%s" target="_Self">%s</a> |

						<a title="%s" class="rwmb-delete-file" href="#" data-attachment_id="%s">&#42</a>
