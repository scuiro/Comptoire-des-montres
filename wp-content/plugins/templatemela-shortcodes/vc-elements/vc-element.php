	...
	vc_map( array (
			...
			'params' 		=> array (
				...
				array (
					...
					'description' 	=> __('Limtation of Post Description. ex.100', 'tmpmela-opts'),
					'admin_label'	=> false,
				),			
		)
	));	
...
vc_map( array (
		'base' 			=> 'tmpmela_single_category',
		'name' 			=> __('Product Category', 'tmpmela-opts'),
		'description' 	=> __('Show single or multiple category list by ID', 'tmpmela-opts'),
		'category' 		=> __('Templatemela Builder', 'tmpmela-opts'),
		...
		'params' 		=> array (
			array (
					...
					'description' 	=> __('Text1  ex. Table Lights', 'tmpmela-opts'),
					'admin_label'	=> false,
				),
			array (
				'param_name' 	=> 'category_name',
				'type' 			=> 'textfield',
				'heading' 		=> __('Category Ids', 'tmpmela-opts'),
				'description' 	=> __('Add multiple product category ids (ex. 20, 25 ,33.. etc.)' , 'tmpmela-opts'),
				'admin_label'	=> true,
				'value'			=> array_flip( tmpmela_get_categories( 'product_cat' ) ),
			),
			array (
	...
	vc_map( array (
			...
			'params' 		=> array (
				...
				array (
                    ...
                    'description' 	=> __('Portfilio Image Width in pixcel (note:enter number without px ex.1200)', 'tmpmela-opts'),
                    'admin_label'	=> false,
                ),
                array (
                    'param_name' 	=> 'height',
                    ...
                    'description' 	=> __('Portfilio Image Height in pixcel (note:enter number without px ex.938)', 'tmpmela-opts'),
                    'admin_label'	=> false,
                ),
                array (
					'param_name' 	=> 'excerpt_length',
