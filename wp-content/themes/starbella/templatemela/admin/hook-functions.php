...
/*-----------------------------------------------------------------------------------*/
// header.php			
function tmpmela_header_before()
{
    do_action('tmpmela_header_before');
}
...
function tmpmela_header()
{
    do_action('tmpmela_header');
}
...
function tmpmela_header_inside()
{
    do_action('tmpmela_header_inside');
}
...
function tmpmela_header_after()
{
    do_action('tmpmela_header_after');
}
...
function tmpmela_footer_before()
{
    do_action('tmpmela_footer_before');
}
...
function tmpmela_footer_inside()
{
    do_action('tmpmela_footer_inside');
}
...
function tmpmela_footer_after()
{
    do_action('tmpmela_footer_after');
}
...
function tmpmela_content_before()
{
    do_action('tmpmela_content_before');
}
...
function tmpmela_content_after()
{
    do_action('tmpmela_content_after');
}
...
function tmpmela_main_before()
{
    do_action('tmpmela_main_before');
}
...
function tmpmela_left_before()
{
    do_action('tmpmela_left_before');
}
...
function tmpmela_left_after()
{
    do_action('tmpmela_left_after');
}
...
function tmpmela_right_before()
{
    do_action('tmpmela_right_before');
}
...
function tmpmela_right_after()
{
    do_action('tmpmela_right_after');
}
...
function tmpmela_custom_css()
{
    do_action('tmpmela_custom_css');
}
