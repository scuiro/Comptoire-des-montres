...
<?php get_header(); ?>
<div id="main-content"
     class="main-content sitemap-page blog-page blog-filter <?php echo esc_attr(tmpmela_sidebar_position()); ?>">
        ...
        <div class="archive-content">
            <div class="sitemap-item">
                <div class="sitemap-pages">
                    <h2>
                        <?php esc_html_e('Pages', 'starbella'); ?>
                    </h2>
                    <ul>
            ...
            <div class="sitemap-item">
                <div class="sitemap-category">
                    <h2>
                        <?php esc_html_e('Category Archives', 'starbella'); ?>
                    </h2>
                    <ul>
                        <?php wp_list_categories(array('feed' => esc_html__('RSS', 'starbella'), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false)); ?>
                    </ul>
                </div>
                <div class="clear"></div>
                <div class="sitemap-month-archieves">
                    <h2>
                        <?php esc_html_e('Monthly Archives', 'starbella'); ?>
                    </h2>
                    <ul>
                ...
                <div class="sitemap-authors">
                    <h2>
                        <?php esc_html_e('Author Archives', 'starbella'); ?>
                    </h2>
                    <ul>
