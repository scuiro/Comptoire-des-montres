<?php
/**
 * Implement Custom Header functionality for TemplateMela
 *
 * @package WordPress
...
{
    /**
     * Filter TemplateMela custom-header support arguments.
     *
     * @since TemplateMela 1.0
     *
     * @param array $args {
    ...
    function tmpmela_admin_header_image()
    {
        ...
        <div id="headimg">
            <?php if (get_header_image()) : ?>
                <img src="<?php header_image(); ?>" alt="<?php echo esc_attr_e('headerimage', 'starbella'); ?>">
            <?php endif;
            $css = ' style="color:#%s;"'; ?>
            <h3 class="displaying-header-text"><a id="name"<?php echo sprintf($css, get_header_textcolor()); ?>
